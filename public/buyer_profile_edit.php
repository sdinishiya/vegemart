...
<html>
    ...
    <?php 
        ...
        <div class="tab has-text-centered">
            ...
            <button class="tabButton" onclick="openfun(event, 'orders')">My Orders</button>
        </div>
        <div id="profile" class="tabcontent">
            <div class="columns group mt-0 pt-0">
                <div class="column is-3 pl-1 pr-1"></div>
                <div class="column is-6 pl-1 pr-1">
                    <div class="updateForm">
                        <form id="UpdateProduct" action="../src/buyer_profile_edit_submit.php" method="post" enctype="multipart/form-data">
