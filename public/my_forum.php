    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="tab has-text-centered">
                    <button id="tab-button" onClick="location.href='http://localhost/vegemart/forum/forum.php';">Home</button>
                    <button id="tab-button" style="background-color: #D7DBDD;" onClick="location.href='http://localhost/vegemart/forum/my_forum.php';">My Posts</button>
            </div>
