    ...
    <body>
        <div class="login">
            ...
            <form class="" action="../src/signup_process.php" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="inputBox">
                    <input type="email" name="email" onfocus="this.placeholder = 'ex: example@vegemart.lk'" onblur="this.placeholder = ''" autocomplete="off" title="Should be a valid email as the give type" required="">
                    <label><i class="fas fa-envelope"></i>&nbsp;&nbsp;&nbsp;Email</label>    
                </div> 
                <div class="inputBox">
                    <input type="text" name="phoneNum" onfocus="this.placeholder = 'ex: +94771570227'" onblur="this.placeholder = ''" pattern='^\+?\d{11}' title="Should be a valid contact number give type" autocomplete="off" required="">
