        ...
        while($row = mysqli_fetch_assoc($result)){
            if($oldPassword === $row['password'])  {    
                ...
                if ($newPassword != $newConfirmPassword){
                    ...
                    if($imageName==""){
                        $updateQuery= "UPDATE `users` SET fName = '".$newFName."', lName = '".$newLName."', email ='".$newEmail."', phoneNum = '".$newPhoneNum."', street = '".$newStreet."', city = '".$newCity."', username = '".$newUsername."', `password` = '".$newPassword."' WHERE id = '".$id."' ";
                    }
                    else{
                        $updateQuery= "UPDATE `users` SET fName = '".$newFName."', lName = '".$newLName."', email ='".$newEmail."', phoneNum = '".$newPhoneNum."', street = '".$newStreet."',profilePic = '".$imageName."', city = '".$newCity."', username = '".$newUsername."', `password` = '".$newPassword."' WHERE id = '".$id."' ";   
                    }   
